 ...
 * metal=3); PC_ITEM_SCRAP=1, PC_ITEM_WPN_SHOTGUN=5 match packages/common/papercraft_protocol.h.
 */
#include <assert.h>
#include <stdio.h>
...
int main(void) {
    ...
    assert(on_papercraft_item_for_object_destroyed(3) == 5); /* METAL -> PC_ITEM_WPN_SHOTGUN (2026-09-07: "you have to find a shotgun") */
